...
# """ ->
immutable MovingBandit{D <: NonStationaryUnivariateDistribution} <: NonStationaryBandit
    arms::Vector{D}
    ...
    function MovingBandit(arms::Vector{D})
        t0 = 0.0
        K = length(arms)
...
""" ->
function MovingBandit{D <: NonStationaryUnivariateDistribution}(arms::Vector{D})
