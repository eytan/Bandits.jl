...
algorithms = [
    ...
    ThompsonSampling(EBBetaLearner(0.05, 0.1)),
...
filename = "demo.tsv"
io = open(filename, "w")
simulate(algorithms, bandits, T, S, [1_000,10_000], io)
close(io)
